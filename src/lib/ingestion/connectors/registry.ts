...
const torontoConnector = new CKANConnector({
  ...
  cityName: 'Toronto',
  province: 'ON',
  endpoint: 'https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/datastore_search?resource_id=active-building-permits',
...
const bramptonConnector = new ArcGISConnector({
  ...
  cityName: 'Brampton',
  province: 'ON',
  endpoint: 'https://geohub.brampton.ca/arcgis/rest/services/OpenData/Building_Permits/FeatureServer/0/query',
...
const winnipegConnector = new SocrataConnector({
  ...
  cityName: 'Winnipeg',
  province: 'MB',
  endpoint: 'https://data.winnipeg.ca/resource/m4sc-fwh6.json',
  dateField: 'issue_date',
  permitNumField: 'permit_number',
  addressField: 'address',
  contractorField: 'contractor_name',
